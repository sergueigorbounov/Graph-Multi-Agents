...
exports.cartManagerTool = void 0;
var tools_1 = require("@langchain/core/tools");
var zod_1 = require("zod");
exports.cartManagerTool = [
    new tools_1.DynamicStructuredTool({
        ...
        func: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var id = _b.id, name = _b.name, url = _b.url;
            return __generator(this, function (_c) {
                // Logic for adding the item
                return [2 /*return*/, "Item ".concat(name, " added to the cart.")];
            });
        }); },
    }),
    new tools_1.DynamicStructuredTool({
        ...
        func: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                ...
                return [2 /*return*/, "Item with ID ".concat(id, " removed from the cart.")];
            });
        }); },
    }),
    new tools_1.DynamicStructuredTool({
        ...
        func: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, "Cart items listed."];
            });
        }); },
    }),
];
